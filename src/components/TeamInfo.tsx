...
const TeamInfo = () => {
  return (
    <section className="max-w-6xl mx-auto flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-8 py-8 lg:py-16 px-4 xl:px-0">
      <img
      ...
      />
      <div>
        <SubHeading color="orange-500">Our team</SubHeading>
